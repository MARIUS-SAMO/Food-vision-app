...
def train(model: nn.Module,
    ...
    Returns:
        A tuple of the trained model, and lists containing training and testing
        loss as well as training and testing accuracy metrics. Each metric has a
        value in a list for each epoch.

        In the form: (trained_model, train_loss, train_acc, test_loss, test_acc)
