...
# food_vision_app documentation build
...
from food_vision_app import __version__ as release

# -- Project information -----------------------------------------------------

project = "food_vision_app"
author = "Kedro"
...
htmlhelp_basename = "food_vision_appdoc"
...
texinfo_documents = [
    (
        ...
        author,
        "food_vision_app",
        "Project food_vision_app codebase.",
        "Nearest-Neighbour",
    )
]
